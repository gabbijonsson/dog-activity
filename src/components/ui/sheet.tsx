		...
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				className={cn(
					...
					side === 'right' &&
						'inset-y-0 right-0 h-full w-full max-w-[100vw] border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:w-3/4 sm:max-w-sm',
					side === 'left' &&
						'inset-y-0 left-0 h-full w-full max-w-[100vw] border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:w-3/4 sm:max-w-sm',
					side === 'top' &&
